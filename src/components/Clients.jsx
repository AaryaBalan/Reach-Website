    ...
    return (
        <section className="py-16 bg-white border-t border-gray-100 overflow-hidden font-['Poppins']">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-10">
                <h3 className="text-2xl font-bold text-[#1e3a5f] mb-2">Precious & Happy Clients</h3>
            ...
            <div className="relative max-w-full overflow-hidden">
                ...
                <div className="flex gap-12 animate-marquee items-center min-w-max">
                    {[...clients, ...clients, ...clients, ...clients].map((client, index) => (
                        <div
                            key={index}
                            className="flex-shrink-0 w-48 h-24 bg-white rounded-xl border border-gray-100 p-4 hover:shadow-lg hover:border-[#0d9488]/30 transition-all duration-300 flex items-center justify-center group"
                        >
                            <img
                                src={client.logo}
                                alt={client.alt}
