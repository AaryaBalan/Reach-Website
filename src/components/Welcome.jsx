            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        <div className="absolute -inset-4 bg-[#0d9488]/10 rounded-tr-[4rem] rounded-bl-[4rem]"></div>
                        <div className="relative bg-white p-8 lg:p-12 rounded-tr-[3rem] rounded-bl-[3rem] shadow-xl border border-gray-100">
                            <h2 className="text-3xl lg:text-5xl font-bold text-[#1e3a5f] mb-6 leading-tight">
                                Cleanliness is <br />
                                <span className="text-[#0d9488]">Power.</span>
                            </h2>
                            ...
                            <p className="text-gray-500 italic border-l-4 border-[#0d9488] pl-4">
                    ...
                    <div className="space-y-8">
                        <div>
                            <span className="text-[#0d9488] font-bold tracking-wider uppercase text-sm mb-2 block">Our Philosophy</span>
                            <h3 className="text-3xl font-bold text-[#1e3a5f] mb-4">Innovation in Every Sweep</h3>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:border-[#0d9488] transition-colors group">
                                <div className="w-12 h-12 bg-[#0d9488]/10 rounded-lg flex items-center justify-center mb-4 text-[#0d9488]">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
                                </div>
                                <h4 className="text-[#1e3a5f] font-bold mb-2">Efficient</h4>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:border-[#0d9488] transition-colors group">
                                ...
                                <h4 className="text-[#1e3a5f] font-bold mb-2">Reliable</h4>
